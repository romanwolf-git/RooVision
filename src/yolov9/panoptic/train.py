...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    if RANK in {-1, 0}:
        ...
        if plots:
            plot_results_with_masks(file=save_dir / 'results.csv')  # save training_results.png
            files = ['training_results.png', 'confusion_matrix.png', *(f'{x}_curve.png' for x in ('F1', 'PR', 'P', 'R'))]
